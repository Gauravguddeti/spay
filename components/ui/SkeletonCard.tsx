...
export function SkeletonCard({ className, lines = 2 }: SkeletonCardProps) {
  return (
    <div
      className={cn(
        "rounded-none border border-border/70 bg-card p-5 shadow-sm animate-pulse",
        className,
      )}
    >
...
export function SkeletonKanbanCard() {
  return (
    <div className="rounded-none border border-border bg-card p-3 shadow-sm animate-pulse">
...
export function SkeletonKanbanColumn() {
  return (
    <div className="min-w-[280px] w-[280px] space-y-2 rounded-none border-2 border-transparent bg-muted/50 p-3">
